...
export default function ItemsClientPage() {
  ...
  const headerStats = [
    {
      label: t("generated.dashboard.items.stock"),
      value:
    ...
    {
      label: t("generated.dashboard.items.products"),
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        stats={headerStats}
        title={t("generated.dashboard.items.itemManagement")}
      />
          ...
          <div className="border-b px-4">
            <TabsList className="h-auto" variant="line">
              <TabsTrigger className="gap-2 py-2.5" value="assortment">
                ...
                <span>{t("generated.dashboard.items.stockStatus")}</span>
              ...
              <TabsTrigger className="gap-2 py-2.5" value="definitions">
                ...
                <span>{t("generated.dashboard.items.productCatalog")}</span>
                <Badge className="ml-1" variant="secondary">
                  {totalItems}
                </Badge>
              </TabsTrigger>
