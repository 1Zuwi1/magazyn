// biome-ignore-all lint/correctness/noNestedComponentDefinitions: This is a pattern recommended by the library to be able to use hooks in the custom components.
