...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: It is safe to use document.cookie here.
      ...
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>
              {translateMessage("generated.ui.sidePanel")}
            </SheetTitle>
            <SheetDescription>
              {translateMessage("generated.ui.displaysMobileSidebar")}
            </SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">
        {translateMessage("generated.ui.toggleSidebar")}
      </span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      aria-label={translateMessage("generated.ui.toggleSidebar")}
      className={cn(
      ...
      tabIndex={-1}
      title={translateMessage("generated.ui.toggleSidebar")}
      {...props}
    />
  )
}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      className={cn(
        "relative flex min-h-0 min-w-0 flex-1 flex-col bg-background md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className
      )}
