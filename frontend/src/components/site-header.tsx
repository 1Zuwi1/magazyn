...
export default function SiteHeader() {
  ...
  return (
    <header className="flex standalone:hidden h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
      <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
        <SidebarTrigger className="-ml-1 standalone:hidden" />
        <Separator
          className="mx-2 standalone:hidden data-[orientation=vertical]:h-8"
