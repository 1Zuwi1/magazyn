...
public class ExportController {
    ...
    public ResponseEntity<String> exportAllRacks() {
        return ResponseEntity.ok()
                .header("Content-Disposition", "attachment; filename=racks.csv")
                .body(warehouseExportService.exportAllRacks());
    }
    ...
    public ResponseEntity<String> exportAllAssortments() {
        return ResponseEntity.ok()
                .header("Content-Disposition", "attachment; filename=assortments.csv")
                .body(warehouseExportService.exportAllAssortments());
    }
