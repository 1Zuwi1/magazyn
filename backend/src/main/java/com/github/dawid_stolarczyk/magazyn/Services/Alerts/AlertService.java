...
public class AlertService {
    ...
    private AlertDto mapToDto(Alert alert) {
        return AlertDto.builder()
                .id(alert.getId())
                .rackId(alert.getRack().getId() != null ? alert.getRack().getId() : null)
                .rackMarker(alert.getRack().getMarker() != null ? alert.getRack().getMarker() : null)
                .warehouseId(alert.getWarehouse().getId() != null ? alert.getWarehouse().getId() : null)
                .warehouseName(alert.getWarehouse().getName() != null ? alert.getWarehouse().getName() : null)
